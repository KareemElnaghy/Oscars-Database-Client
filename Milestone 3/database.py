...
class Database:
    ...
    username = "freedb_kareemelnaghy"
    password = "MGGsm25HZZZW&x4"
    databaseName = "freedb_oscars"
    ...
    def add_user(
        self, email, username, birthDate, gender, country
    ):  # query to add a user
    ...
    def check_movie_exists(
        self, movie_title, release_year
    ):  # helper function that executes a query to validate existence of a movie
    ...
    ):  # helper function that executes a query to validate existence of a person
