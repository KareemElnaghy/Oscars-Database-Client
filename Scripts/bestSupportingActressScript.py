...
with open('best_supporting_actress_full_details.csv', mode='w', encoding='utf-8', newline='') as file1:
...
with open('best_supporting_actress_basic.csv', mode='w', encoding='utf-8', newline='') as file2:
